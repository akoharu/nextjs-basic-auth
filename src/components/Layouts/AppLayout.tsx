          ...
          */}
            <div>
                <Transition.Root show={sidebarOpen} as={Fragment}>
                    <Dialog
                        ...
                        <Transition.Child
                            ...
                            <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-emerald-700">
                                <Transition.Child
                                    as={Fragment}
                ...
                <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
                    ...
                    <div className="flex flex-col flex-grow pt-5 bg-emerald-700 overflow-y-auto">
